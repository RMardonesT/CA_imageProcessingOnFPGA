...
HD_PWD='C:/Users/ricar/OneDrive/Escritorio/MEMORIA/CA_imageProcessingOnFPGA/VIVADO/video/video.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log uart_basic.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source uart_basic.tcl
