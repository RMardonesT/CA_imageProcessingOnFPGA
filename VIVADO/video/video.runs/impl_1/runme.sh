...
HD_PWD='C:/Users/ricar/OneDrive/Escritorio/MEMORIA/CA_imageProcessingOnFPGA/VIVADO/video/video.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log uart_basic.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source uart_basic.tcl -notrace
