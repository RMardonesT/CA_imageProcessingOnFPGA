...
HD_PWD='C:/Users/ricar/OneDrive/Escritorio/MEMORIA/CODIGOS/VIVADO/sesion 9/sesion 9.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log TOP_9.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source TOP_9.tcl -notrace
