...
HD_PWD='C:/Users/ricar/OneDrive/Escritorio/MEMORIA/CODIGOS/VIVADO/sesion 9/sesion 9.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log TOP_9.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source TOP_9.tcl
