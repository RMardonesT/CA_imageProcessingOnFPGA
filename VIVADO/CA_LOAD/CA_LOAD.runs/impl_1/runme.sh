...
HD_PWD='C:/Users/ricar/OneDrive/Escritorio/MEMORIA/CA_imageProcessingOnFPGA/VIVADO/CA_LOAD/CA_LOAD.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log GRID_SCRIPT.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source GRID_SCRIPT.tcl -notrace
