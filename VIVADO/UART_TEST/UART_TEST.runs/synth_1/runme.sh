...
HD_PWD='C:/Users/ricar/OneDrive/Escritorio/MEMORIA/CA_imageProcessingOnFPGA/VIVADO/UART_TEST/UART_TEST.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log TOP_RECIEVE.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source TOP_RECIEVE.tcl
