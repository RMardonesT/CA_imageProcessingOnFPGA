...
HD_PWD='C:/Users/ricar/OneDrive/Escritorio/MEMORIA/CA_imageProcessingOnFPGA/VIVADO/UART_TEST/UART_TEST.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log TOP_RECIEVE.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source TOP_RECIEVE.tcl -notrace
