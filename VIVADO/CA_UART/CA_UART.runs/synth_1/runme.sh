...
HD_PWD='C:/Users/ricar/OneDrive/Escritorio/MEMORIA/CA_imageProcessingOnFPGA/VIVADO/CA_UART/CA_UART.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log TOP_CA.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source TOP_CA.tcl
