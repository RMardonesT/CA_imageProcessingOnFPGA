...
HD_PWD='C:/Users/ricar/OneDrive/Escritorio/MEMORIA/CA_imageProcessingOnFPGA/VIVADO/CA_UART/CA_UART.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log TOP_CA.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source TOP_CA.tcl -notrace
