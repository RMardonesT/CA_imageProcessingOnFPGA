...
HD_PWD='C:/Users/ricar/OneDrive/Escritorio/MEMORIA/CODIGOS/VIVADO/CA_test/CA_test.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Grid_load.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Grid_load.tcl
