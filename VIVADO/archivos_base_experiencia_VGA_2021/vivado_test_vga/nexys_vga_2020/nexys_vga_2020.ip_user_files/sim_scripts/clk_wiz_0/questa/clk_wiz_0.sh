...
copy_setup_file()
{
  ...
  if [[ ($1 != "") ]]; then
    ...
    lib_map_path="C:/Users/ricar/OneDrive/Escritorio/MEMORIA/CA_imageProcessingOnFPGA/VIVADO/archivos_base_experiencia_VGA_2021/vivado_test_vga/nexys_vga_2020/nexys_vga_2020.cache/compile_simlib/questa"
  fi
