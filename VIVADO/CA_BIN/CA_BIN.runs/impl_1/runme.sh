...
HD_PWD='C:/Users/ricar/OneDrive/Escritorio/MEMORIA/CA_imageProcessingOnFPGA/VIVADO/CA_BIN/CA_BIN.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log TOP_BIN.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source TOP_BIN.tcl -notrace
