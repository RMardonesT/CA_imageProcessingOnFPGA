...
HD_PWD='C:/Users/ricar/OneDrive/Escritorio/MEMORIA/CA_imageProcessingOnFPGA/VIVADO/CA_BIN/CA_BIN.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log TOP_BIN.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source TOP_BIN.tcl
