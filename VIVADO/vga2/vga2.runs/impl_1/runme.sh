...
HD_PWD='C:/Users/ricar/OneDrive/Escritorio/MEMORIA/CA_imageProcessingOnFPGA/VIVADO/vga2/vga2.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log TOP_CPY.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source TOP_CPY.tcl -notrace
