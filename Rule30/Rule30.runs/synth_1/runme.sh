...
HD_PWD='C:/Users/ricar/OneDrive/Escritorio/MEMORIA/CODIGOS/Rule30/Rule30.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log celda.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source celda.tcl
